...
const toggleCard = (card) => {
  ...
  <div className="registro-container">
    <h1 className="registro-title">Historial de informes municipales.</h1>
    <h2 className="registro-subtitle">Visualice los informes registrados por cada municipio y consulte la información de periodos anteriores.</h2>
