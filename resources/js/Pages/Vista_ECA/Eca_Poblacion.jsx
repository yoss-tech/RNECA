  ...
  useEffect(() => {
    const checkRegistro = async () => {
      try {
        ...
        setRegistro(data.registro_existente); // Almacena el booleano directamente
      }
      catch (error) {
        console.error('Sin registros aún', error);
        ...
        <form className="form-registro" onSubmit={handleSubmit}>
          <div className="form-registro">
            ...
            <div className="page-botones">
              ...
              {registro === false && (
                <button type="submit" className="btn-primario" onClick={handleSubmit} disabled={registro}>Guardar</button>
              )}
              {mostrarModal && (
                <Mod_Poblacion
